...
-deliveryNote
    ...
    from: Adolfo Su�rez Madrid�Barajas Airport, Spain
    to: London Heathrow, UK
    deliveryCompany: DHL
-deliveryNote
    meanOfTransportation: Truck
    from: Fazenda S�o Francisco Citros, Brazil
    to: S�o Paulo�Guarulhos International Airport, Brazil
    deliveryCompany: Correios
-deliveryNote
    meanOfTransportation: Van
    from: Porto International Airport, Portugal
    to: Adolfo Su�rez Madrid�Barajas Airport, Spain
...
-deliveryNote
    meanOfTransportation: Flight
    from: S�o Paulo�Guarulhos International Airport, Brazil
